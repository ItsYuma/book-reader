...
public class Mapper
{
    ...
    {
        return sessions.Select(s => new ReadingSessionDto(s.BookTitle, s.BookIsbn, s.PageIndex, s.DateBeginning, s.DateLastReading)).ToList();
    }
    ...
    public IList<ReadingSession> ListDtoToListEntity(IList<ReadingSessionDto> sessions)
    {
        ...
        return sessions.Select(s => new ReadingSession(s.BookTitle, s.BookIsbn, s.PageIndex, s.DateBeginning, s.DateLastReading))
